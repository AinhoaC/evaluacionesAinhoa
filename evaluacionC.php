 ...
 # Generamos el informe excel en base a las preguntas de la base de datos
    if ( isset( $_POST['informe'] ) ) {
       ...
       //Primero hay que cerrar la fecha hasta de la evaluación
        ...
        $updateFechEval = mysqli_query( $conn, "UPDATE evaluaciones set evaluaciones.fechaHasta = CURDATE(), idEstadoEval = 3 
        ...
        if ( mysqli_num_rows( $evalPregUsu ) != 0 ) {
            ...
            $CadenaJSON .= "]' '" . $_SESSION["RutaPlantilla"] ."' '" . $_SESSION["RutaInforme"] . '_' .$evaluacion . ".xlsm'";
            $CadenaJSON = str_replace("'", '"', $CadenaJSON);
        
//printf("<br> Cadena JSON: " . $CadenaJSON);
// SE COMENTA PARA SUBIR A PROD. TEMPORALMENTE
          
            $archivo = fopen($_SESSION["GeneradorInforme"], "w+b"); 
    ...
    echo '<script type="text/javascript">
            alert("Informe generado correctamente ***EN DESARROLLO***"); 
            window.location.href = "archivo.php?download_csv=1";
        </script>';
        ...
        <form method="post">
            <div class="row" >
                <div class="form-group">
                    ...
                    <input type="text" class="clsInputEval" id="inputEvaluacion" name="inputEvaluacion" placeholder="Evaluación" maxlength="5" value="<?php echo $campoCodEvaluacion; ?>" readonly>
                </div>
                <div class="form-group">
